...
@interface SharedDetailViewModel : SharedKmp_observableviewmodel_coreViewModel
- (instancetype)initWithMuseumRepository:(SharedMuseumRepository *)museumRepository __attribute__((swift_name("init(museumRepository:)"))) __attribute__((objc_designated_initializer));
...
- (void)setIdObjectId:(int32_t)objectId __attribute__((swift_name("setId(objectId:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListViewModel")))
@interface SharedListViewModel : SharedKmp_observableviewmodel_coreViewModel
- (instancetype)initWithMuseumRepository:(SharedMuseumRepository *)museumRepository __attribute__((swift_name("init(museumRepository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithCloseables:(SharedKotlinArray<id<SharedKotlinAutoCloseable>> *)closeables __attribute__((swift_name("init(closeables:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@interface SharedDetailViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^museumObjectFlow)(SharedKotlinUnit *(^)(SharedMuseumObject * _Nullable, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("museumObjectFlow")));
@property (readonly) SharedMuseumObject * _Nullable museumObject __attribute__((swift_name("museumObject")));
@end

@interface SharedListViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^objectsFlow)(SharedKotlinUnit *(^)(NSArray<SharedMuseumObject *> *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("objectsFlow")));
@property (readonly) NSArray<SharedMuseumObject *> *objects __attribute__((swift_name("objects")));
@end
